    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333333; line-height: 1.6; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
        ...
        <div style="padding: 32px 24px;">
          ...
          <div style="text-align: center; margin: 32px 0;">
            <a href="${settingsUrl}#data-export" style="display: inline-block; padding: 14px 28px; background-color: #0ea5e9; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; box-shadow: 0 4px 6px -1px rgba(14, 165, 233, 0.2);">
              Download Data
            </a>
          </div>
          <p style="font-size: 14px; color: #64748b; margin-top: 32px;">
            If the button above does not work, copy and paste this link into your browser:
            <br />
            <a href="${settingsUrl}#data-export" style="color: #0ea5e9; word-break: break-all;">${settingsUrl}#data-export</a>
          </p>
