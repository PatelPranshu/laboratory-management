...
app.use(cors({
  origin: function (origin, callback) {
    ...
    if (!origin || origin === 'https://mypatholabs.tech' || origin === 'https://www.mypatholabs.tech' || origin === 'https://mylaboratory.onrender.com' || origin === 'https://mypatholabs2.onrender.com' || origin === 'https://mypatholabs3.onrender.com' || allowedOrigins.includes(origin)) {
      return callback(null, true);
    }
...
app.use(helmet({
  contentSecurityPolicy: process.env.NODE_ENV === 'production' ? {
    directives: {
      ...
      connectSrc: ["'self'", "https://api.mypatholabs.tech", "https://mylaboratory.onrender.com", "https://mypatholabs2.onrender.com", "https://mypatholabs3.onrender.com"]
    }
  } : false,
